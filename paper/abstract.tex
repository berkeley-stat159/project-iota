...
analyzing fMRI scans of one subject using generalized linear model (GLM). Before
data analysis, we smoothed the data spatially and corrected noise in the fMRI
data. On the preprocessed data, we performed student t tests to identify the voxels
responding to designed stimulus. Having localized the activated voxels, we
closely examined the behavior of these voxels and validated our assumptions 
