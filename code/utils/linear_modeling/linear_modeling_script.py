...
# First reshape
b_vols = linear_modeling.reshape(in_brain_mask, vol_shape, beta)
...
# Reshape t values
t_val = linear_modeling.reshape(in_brain_mask, vol_shape, t_mat)
# Reshape p values
p_val = linear_modeling.reshape(in_brain_mask, vol_shape, p_mat)
